...
<title>カタカナランダム(イメージヒントあり)</title>

    <div class="katakana-title text-center">
        <h2 class="fs-3 fw-bold">カタカナプログラム</h2>
        <h3>ランダムカタカナ(イメージ有り)</h3>
    </div>
...
<script>
        ...
        function shake(){
            ...
            $id("saikoro").innerHTML = "<img src='../img/kids-pikori/hiragana/"+dice+"a.png' width='250px' class='me-3'>";
