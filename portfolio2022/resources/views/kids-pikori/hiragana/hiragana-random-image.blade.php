...
<h2 class="fs-3 fw-bold">ひらがなプログラム</h2>
    ...
    function shake(){
        ...
        $id("saikoro").innerHTML = "<img src='../img/kids-pikori/hiragana/" + dice +  "a.png' width='250px' height='250px' class='me-3'>";
        $id("saikoro2").innerHTML = "<button class= 'btn hiragana-text random-btn'>" + hira[dice] + "</button>"
        $id("saikoro3").innerHTML = "<button class='btn btn-success py-3 px-3 fs-3 me-5 mt-3' onclick= " +"hiragana()    > 音声  </button>";
